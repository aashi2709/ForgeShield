...
Machine operation remained within the expected operating conditions during the observed period.

## Sensor Context

| Sensor | Value |
|---|---:|
| Air temperature | 297.93 |
| Process temperature | 306.42 |
| Rotational speed | 1719 |
| Torque | 30.95 |
| Tool wear | 76 |
