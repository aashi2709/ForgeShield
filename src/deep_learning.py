...
def main():
    ...
    print("\n" + "=" * 70)
    print("FORGESHIELD | LSTM RUL REGRESSOR")
    print("=" * 70)
    ...
    np.save(
        MODEL_DIR / "lstm_val_predictions.npy",
        val_predictions,
    )

    np.save(
        MODEL_DIR / "lstm_train_loss.npy",
        np.asarray(
            history["train_loss"]
        ),
    )
