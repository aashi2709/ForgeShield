...
def main():
    ...
    print("\n" + "=" * 70)
    print("FORGESHIELD | CNN-LSTM RUL REGRESSOR")
    print("=" * 70)
    ...
    np.save(
        MODEL_DIR / "cnn_lstm_val_predictions.npy",
        val_predictions,
    )

    np.save(
        MODEL_DIR / "cnn_lstm_train_loss.npy",
        np.asarray(
            history["train_loss"]
        ),
    )
    ...
    np.save(
        MODEL_DIR / "cnn_lstm_val_loss.npy",
        np.asarray(
            history["val_loss"]
        ),
    )
    ...
    print(
        "  ✓ cnn_lstm_val_predictions.npy"
    )

    print(
        "  ✓ cnn_lstm_train_loss.npy"
    )

    print(
        "  ✓ cnn_lstm_val_loss.npy"
    )
